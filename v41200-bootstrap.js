...
(()=>{
  ...
  window.KEYSUITE_VERSION='4.22.05';
  window.KEYSUITE_BUILD='V4.22.05';
  const VERSION='42205';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.22.05';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.22.05':'V4.22.05'});document.documentElement.setAttribute('data-keysuite-version','4.22.05')}catch(_){} }
  (async()=>{
    ...
    try{window.dispatchEvent(new CustomEvent('KEYSUITE_V41300_RUNTIME_READY',{detail:{version:'4.22.05'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_RUNTIME_READY',{detail:{version:'4.22.05'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_BRAND_RECOVERY'))}catch(_){ }
  })();
})();
