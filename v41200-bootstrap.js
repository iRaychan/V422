...
(()=>{
  ...
  window.KEYSUITE_VERSION='4.22.02';
  window.KEYSUITE_BUILD='V4.22.02';
  const VERSION='42202';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.22.02';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.22.02':'V4.22.02'});document.documentElement.setAttribute('data-keysuite-version','4.22.02')}catch(_){} }
  (async()=>{
    ...
    try{window.dispatchEvent(new CustomEvent('KEYSUITE_V41300_RUNTIME_READY',{detail:{version:'4.22.02'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_RUNTIME_READY',{detail:{version:'4.22.02'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_BRAND_RECOVERY'))}catch(_){ }
  })();
})();
