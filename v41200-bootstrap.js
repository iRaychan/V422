...
(()=>{
  ...
  window.KEYSUITE_VERSION='4.21.09';
  window.KEYSUITE_BUILD='V4.21.09';
  const VERSION='42111';
  ...
  function updateVisibleVersion(){try{document.title='KeySuite V4.21.09';document.querySelectorAll('.suite-version,.brand small,.auth-brand small').forEach(el=>{const t=String(el.textContent||'');if(/KeySuite|Full Suite|V\d/i.test(t))el.textContent=t.includes('Full Suite')?'Full Suite V4.21.09':'V4.21.09'});document.documentElement.setAttribute('data-keysuite-version','4.21.09')}catch(_){} }
  (async()=>{
    ...
    try{window.dispatchEvent(new CustomEvent('KEYSUITE_V41300_RUNTIME_READY',{detail:{version:'4.21.09'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_RUNTIME_READY',{detail:{version:'4.21.09'}}));window.dispatchEvent(new CustomEvent('KEYSUITE_V41223_BRAND_RECOVERY'))}catch(_){ }
  })();
})();
